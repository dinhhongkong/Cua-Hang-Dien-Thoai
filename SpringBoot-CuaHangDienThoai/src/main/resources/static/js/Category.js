...
$(document).ready(function () {
    ...
    $(document).on("click", ".box-quicklink.accessories a", function (n) {
        ...
        if (t == "999") {
            ...
            $(this).addClass("check");
            BuildActiveFilter(!0);
        } else $(".box-quicklink.accessories a[data-id='999']").removeClass("check"), cidsParams.indexOf(t) >= 0 ? (cidsParams.splice(cidsParams.indexOf(t), 1), $(".box-quicklink.accessories a[data-id=" + t + "]").removeClass("check")) : (cidsParams.push(t), $.unique(cidsParams), $(".box-quicklink.accessories a[data-id=" + t + "]").addClass("check"), BuildActiveFilter());
