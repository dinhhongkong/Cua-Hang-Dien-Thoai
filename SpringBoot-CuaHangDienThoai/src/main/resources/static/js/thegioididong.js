...
function initCpKids() {
    if (!isInitCpKids) {
        if ((openPopupcode(), console.log("initCpKids_"), $(".couponform").length > 0)) {
            $(".couponform").unbind();
            $(".couponform").on("keyup change paste", "input, select, textarea", function () {
                validateCpKids();
            });
        }
        $(window).keydown(function (n) {
            if (n.keyCode == 13) return console.log("prevent enter"), n.preventDefault(), !1;
        });
        isInitCpKids = !0;
        $("#sendFirstCp")
            .unbind()
            .click(function (n) {
                if ((n.preventDefault(), console.log("sendfrsCp"), isSendingFcp !== !0) && validatefrsCp() !== !1) {
                    ...
                    $.ajax({
                        ...
                        success: function (n) {
                            ...
                            n.status != null && parseInt(n.status) == 0
                                ...
                                : ($(".code-note .required").html(n.message), $(".code-note .required").removeClass("hide"));
                            isSendingFcp = !1;
                            return;
                        },
                        complete: function () {},
        ...
        $("#submitCp")
            .unbind()
            .click(function (n) {
                if ((n.preventDefault(), console.log("sendCpKids__"), isSendingCpKids !== !0) && validateCpKids() !== !1) {
                    ...
                    $.ajax({
                        ...
                        success: function (n) {
                            ...
                            n.status != null && parseInt(n.status) == 0
                                ...
                                : ($(".promote__form .required").html(n.message), $(".promote__form .required").removeClass("hide"));
                            isSendingCpKids = !1;
                            return;
                        },
                        complete: function () {},
...
function validateCpKids() {
    var n = !0;
    return $("#cpKPhone").val().length > 9 && $("#cpKName").val().length > 3 ? $(".couponform button").removeClass("hasvalue").addClass("hasvalue") : ($(".couponform button").removeClass("hasvalue"), (n = !1)), n;
}
function openPopupcode() {
    if ((console.log("openPopupcode"), $(".code-form").length > 0)) {
        ...
        $(".formcode").on("keyup change paste", "input, select, textarea", function () {
            validatefrsCp();
        });
    }
}
function validatefrsCp() {
    ...
    return (
        $(".code-note .required").html(""),
            ...
            $("#fcpPhone").val().length > 9 && $("#fcpName").val().length > 3 ? $(".formcode button").removeClass("hasvalue").addClass("hasvalue") : ($(".formcode button").removeClass("hasvalue"), (n = !1)),
            n
    );
}
...
function addListProductIntoImpression(n, t, i, r = false) {
    ...
    if (n !== undefined && n.length > 0) {
        ...
        for (e = 0; e < n.length; e++)
            ...
            (gbl_siteId == 1
                ? (f.dimension88 = u.dataset.isRecommended === undefined || u.dataset.isRecommended === !1 ? "No" : "Yes")
                : gbl_siteId == 2 && (f.dimension79 = u.dataset.isRecommended === undefined || u.dataset.isRecommended === !1 ? "No" : "Yes")),
                s.push(f),
                (f = {}),
            ((e + 1 == n.length && o < i) || o == i) && (gtm_ListProductImpressions(s), (o = 0), (s = []));
    }
}
...
function gtm_ProductClick(n, t, i, r, u, f, e, o = false, s = "") {
    ...
    h = [{ name: n, id: t === undefined ? "" : t.toString(), price: i === undefined ? "" : i.toString(), brand: r, category: u, list: f, position: e === undefined ? "" : e.toString() }];
    gbl_siteId !== undefined &&
    (gbl_siteId == 1
        ? ((h[0].dimension88 = o === undefined || o === !1 ? "No" : "Yes"), (h[0].dimension91 = s === undefined || s !== "CleanStock" ? "No" : "Yes"))
        : gbl_siteId == 2 && ((h[0].dimension79 = o === undefined || o === !1 ? "No" : "Yes"), (h[0].dimension82 = s === undefined || s !== "CleanStock" ? "No" : "Yes")));
    c = { ecommerce: { click: { products: h, actionField: { list: f } } }, event: "productClick" };
    dataLayer.push(c);
}
...
function OpenLocation(n) {
    isLoadPopupLocation
        ? $(".locationbox-v2").length > 0
            ? LoadPopupLocationV2()
            : LoadPopupLocation()
        : ($(".locationbox-v2").length > 0 ? (callFirstLoadPopup(), clearPopupLocation($(".locationbox-v2").is(":visible")), $(".locationbox-v2").toggle()) : $(".locationbox").toggle(),
    ...
    n
        ...
        $("#hdLocationWardId").val() == 0 && ($(".locationbox__popup .accept .btnConfirm").addClass("disabled"), $(".locationbox__popup .accept .btnConfirm").html("Má»i báº¡n chá»n Ä‘áº§y Ä‘á»§ Ä‘á»‹a chá»‰")))
...
function changePoupProv(n, t) {
    ...
    $(".locationbox").hasClass("atdetailpage") && ($(".locationbox__popup .accept .btnConfirm").addClass("disabled"), $(".locationbox__popup .accept .btnConfirm").html("Má»i báº¡n chá»n Ä‘áº§y Ä‘á»§ Ä‘á»‹a chá»‰"));
    $.ajax({
        ...
        success: function (i) {
            ...
            (locationShowFull(),
                ...
                $("#district-box-poup li").length == 0 ? ($("#district-box-poup").hide(), $("#boxprovDistrict").addClass("disabled")) : ($("#district-box-poup").show(), $("#boxprovDistrict").removeClass("disabled")),
...
function changePoupDistrict(n, t, i) {
    ...
    $(".locationbox").hasClass("atdetailpage") && $(".locationbox__popup .accept .btnConfirm").html("Má»i báº¡n chá»n Ä‘áº§y Ä‘á»§ Ä‘á»‹a chá»‰");
    $.ajax({
        ...
        success: function (n) {
            ...
            ($("#district-box-poup li a").removeClass("active"),
                $(i).addClass("active"),
                $(i).parents(".locationbox__popup .boxprov__listTT--scroll").slideToggle(),
                ...
                $("#ward-box li").length == 0
                    ? ($("#ward-box").hide(), $("#boxprovWard").addClass("disabled"), $("#lc_btn-Confirm").addClass("disabled"))
                    : $("#hdLocationWardId").val() > 0 && ($("#ward-box").show(), $("#boxprovWard").removeClass("disabled"), $("#lc_btn-Confirm").removeClass("disabled")));
            $("#dldingtext").hide();
        },
        error: function () {
            $("#dldingtext").hide();
...
function locationConfirm() {
    var n = { Address: $("#locationAddress").val(), ProvinceId: $("#hdLocationProvinceId").val(), DistrictId: $("#hdLocationDisId").val(), WardId: $("#hdLocationWardId").val(), CustomerSex: getLocationCustomer().Sex };
    $.ajax({
        url: urlRoot + "/Common/locationConfirm",
        type: "POST",
        xhrFields: { withCredentials: urlRoot.includes("thegioididong.com") || urlRoot.includes("dienmayxanh.com") ? !1 : !0 },
        data: {
            newcustomer: n,
        ...
        success: function (n) {
            if (n != "" && n.status == 1) {
                if (typeof extParams != "undefined" && ((isCallFastDeli && parseInt(document.cateID) > 0 && extParams !== undefined) || extParams.indexOf("fast") >= 0)) {
                    getLocationCustomer().wardID > 0 && extParams.indexOf("fast") < 0 ? extParams.push("fast") : extParams.splice(extParams.indexOf("fast"), 1);
                    BuildLinkHash(!1, !1);
                    ...
                    (location.hash = $(".extend-filter a.fastdeli").hasClass("active") == !1 && getLocationCustomer().wardID > 0 ? "#fastdeli&c=" + searchQuery.CateID : "");
                window.location.reload();
            } else n != "" && n.status == 2 && n.message !== null && n.message !== "" ? (location.href = location.origin + n.message) : $(".preloader").last().hide();
        },
        error: function () {
            $(".preloader").last().hide();
        },
...
function stringToSlug(n) {
    return (
        (n = n.replace(/Ă |Ă¡|áº¡|áº£|Ă£|Ă¢|áº§|áº¥|áº­|áº©|áº«|Äƒ|áº±|áº¯|áº·|áº³|áºµ/g, "a")),
            (n = n.replace(/Ă¨|Ă©|áº¹|áº»|áº½|Ăª|á»|áº¿|á»‡|á»ƒ|á»…/g, "e")),
            (n = n.replace(/Ă¬|Ă­|á»‹|á»‰|Ä©/g, "i")),
            (n = n.replace(/Ă²|Ă³|á»|á»|Ăµ|Ă´|á»“|á»‘|á»™|á»•|á»—|Æ¡|á»|á»›|á»£|á»Ÿ|á»¡/g, "o")),
            (n = n.replace(/Ă¹|Ăº|á»¥|á»§|Å©|Æ°|á»«|á»©|á»±|á»­|á»¯/g, "u")),
            (n = n.replace(/á»³|Ă½|á»µ|á»·|á»¹/g, "y")),
            (n = n.replace(/Ä‘/g, "d")),
            (n = n.replace(/Ă€|Ă|áº |áº¢|Ăƒ|Ă‚|áº¦|áº¤|áº¬|áº¨|áºª|Ä‚|áº°|áº®|áº¶|áº²|áº´/g, "A")),
            (n = n.replace(/Ăˆ|Ă‰|áº¸|áºº|áº¼|Ă|á»€|áº¾|á»†|á»‚|á»„/g, "E")),
            (n = n.replace(/ĂŒ|Ă|á»|á»ˆ|Ä¨/g, "I")),
            (n = n.replace(/Ă’|Ă“|á»Œ|á»|Ă•|Ă”|á»’|á»|á»˜|á»”|á»–|Æ |á»œ|á»|á»¢|á»|á» /g, "O")),
    ...
    if (!isLoadData) {
        try {
            ...
            if (
                ((t = 3),
                    (r = 0),
                o != null && o !== "null" && o !== undefined && ((n = JSON.parse(o)), (t = n != null && n != undefined ? n.ProvinceId : 0), (r = n != null && n != undefined ? n.DistrictId : 0)),
                ...
                t != i && (window.location.href = window.location.origin + window.location.pathname + "?utm_province=" + i + "-" + t)),
            ...
            success: function (n) {
                n != ""
                    ? n.status == 0 || n.status == -1
                        ? ($(".header__address span").html(n.fullAdress), (fullAddress = n.fullAdressPopup))
                        : n.status == 1 &&
                        ($(".header__address span").html(n.fullAdress), (fullAddress = n.fullAdressPopup), n.name != undefined && n.name != null && $(".header__history").html("ÄÆ¡n hĂ ng " + n.name.replace("(", "").replace(")", "")))
                    : $(".header__address span").html("Há»“ ChĂ­ Minh");
            },
            error: function () {},
            complete: function () {
    ...
    $.ajax({
        ...
        success: function (n) {
            ...
            (n.items_count > 0
                ...
                $(".sticky-bar-cart").length > 0 && $(".sticky-bar-cart").append("<span class='sticky-bar-number'>" + n.items_count + "</span>"))
                : ($(".header__cart").removeClass("active"), $(".header__cart .cart-number").html(""), $(".header__cart .cart-number").removeClass("has-cart"), $(".header__cart .icon-cart").html("")));
        },
        error: function () {},
    });
}
    ...
    n == 40
        ? $(t + ".selected").length == 0
            ...
            : $(t).last().hasClass("selected")
                ? ($(t + ".selected").removeClass("selected"), $(t + ":first").addClass("selected"))
                : ((i = $(t + ".selected").next()), i.hasClass("ttitle") && (i = i.next()), $(t + ".selected").removeClass("selected"), i.addClass("selected"))
        : n == 38 &&
        ($(t + ".selected").length == 0
            ? $(t + ":last").addClass("selected")
            : $(t).first().hasClass("selected")
                ? ($(t + ".selected").removeClass("selected"), $(t + ":last").addClass("selected"))
                : ((i = $(t + ".selected").prev()), i.hasClass("ttitle") && (i = i.prev()), $(t + ".selected").removeClass("selected"), i.addClass("selected")));
    return;
}
...
function UpdateSearchKeywordHistory(n, t) {
    $.ajax({ url: urlRoot + "/Common/UpdateSearchKeywordHistory", type: "POST", data: { keyword: n, url: t }, cache: !1, success: function () {}, error: function () {} });
}
                ...
                t > 0 && $("#province-box li").length > 0
                    ? ($("#province-box li a").removeClass("active"),
                        $("#province-box li")
                            .find("a[data-value=" + t + "]")
                            .addClass("active"))
                    : $("#province-box li").length == 0 && ($("#province-box").hide(), $("#boxprovProvince").addClass("disabled")),
                ...
                i > 0 && $("#district-box-poup li").length > 0
                    ? ($("#district-box-poup li a").removeClass("active"),
                        $("#district-box-poup li")
                            .find("a[data-dis=" + i + "]")
                            .addClass("active"))
                    : $("#district-box-poup li").length == 0 && ($("#district-box-poup").hide(), $("#boxprovDistrict").addClass("disabled")),
                ...
                r > 0 && $("#ward-box li").length > 0
                    ? ($("#ward-box li a").removeClass("active"),
                        $("#ward-box li")
                            .find("a[data-value=" + r + "]")
                            .addClass("active"))
                    : $("#ward-box li").length == 0 && ($("#ward-box").hide(), $("#boxprovWard").addClass("disabled")),
            $(".topinstall .headinstall .headinfo .province").length > 0 && $(".topinstall .headinstall .headinfo .province").html($("#h-provincename").text()),
...
function LogOutHistory() {
    $.ajax({
        ...
        cache: !1,
        success: function (n) {
            n != "" && n.status == 1 && $(".txt-history").html("Lá»‹ch sá»­ mua hĂ ng");
        },
        error: function () {},
    });
}
...
function CheckLocationSuggest() {
    if (!IsLoadingSuggest) {
        ...
        var n = GetNamCookiesRunlive("ShowLocationSuggest"),
            t = getCookie(n);
        t == undefined || t == "" ? (setCookie(n, "hide", 365), $("#lc_pop--sugg").removeClass("hide")) : $("#lc_pop--sugg").remove();
        return;
    }
}
...
function LoadViewedHistory(n = "home") {
    ...
    ((f = { productIds: i, categoryIds: r, Viewname: n }),
        $.ajax({
            ...
            success: function (n) {
                container.html(n);
                container.find(".owl-carousel").owlCarousel({ nav: !0, items: 5, slideBy: "page", rewind: !0, smartSpeed: 100 });
            },
        }));
}
function LoadViewedHistoryByCate(n, t) {
    ...
    ((f = { productIds: r, categoryIds: o, Viewname: t }),
        $.ajax({
            ...
            success: function (n) {
                container.html(n);
                container.find(".p-slide .owl-carousel").owlCarousel({ nav: !0, items: 5, slideBy: 5, dots: !1 });
            },
        }));
}
            ...
            success: function (n) {
                n != "" && n.status == 1
                    ? ($("#showPromoteBHX").html(n.message),
                        $(".footer").css("margin-top", 10),
                        $(".prmotebanner-bhx-footer").owlCarousel({ items: 5, slideSpeed: 5e3, nav: !0, dots: !1, slideBy: 5, responsiveRefreshRate: 200 }),
                        CheckBoxBHX(),
                        $("#form-zone-bhx button").click(function (n) {
                            n.preventDefault();
                            pdbxbhxapi.sendCoupon();
...
function CloseBHX() {
    $(".zone-bhx").remove();
    $.ajax({ url: urlRoot + "/Common/AddCookiesBHX", type: "POST", cache: !1, beforeSend: function () {}, success: function () {}, error: function () {} });
}
                ...
                i.click(function (n) {
                    ...
                    if ((n.preventDefault(), !Summiting)) {
                        ...
                        if (((t = $("#PhoneNumber").val().trim()), t != "" && ((i = /((09|03|07|08|05)+([0-9]{8})\b)/g), i.test(t) == !1))) {
                            alert("Sá»‘ Ä‘iá»‡n thoáº¡i cá»§a báº¡n khĂ´ng Ä‘Ăºng Ä‘á»‹nh dáº¡ng!");
                            return;
                        }
                        ...
                        $.ajax({
                            ...
                            success: function (n) {
                                ...
                                ((hasSusses = !0),
                                    ...
                                    $("#global_form").html("<a href='javascript:OpenFeedbackGlobal()'>ÄĂ³ng</a><span>ChĂ¢n thĂ nh cáº£m Æ¡n Ă½ kiáº¿n Ä‘Ă³ng gĂ³p cá»§a quĂ½ khĂ¡ch!<span>"));
                            },
                            error: function () {
                                $("#dldingtext").hide();
                            },
    ...
    if (r !== "" && r !== null && r != undefined && ((i = r.split(",")), i != null && i.length > 0))
        for (u = 0; u < i.length; u++) {
            if (
                ...
                n != undefined && n.length > 0 && n.find("a.item-ss") != undefined && n.find("a.item-ss").hasClass("active") == !1 && n.find("a.item-ss").addClass("active").html("<i></i> ÄĂ£ thĂªm so sĂ¡nh"),
                    (t = $(".compare-popup .pro-compare *[data-id=" + f + "]")),
                t != undefined && t.length > 0)
            )
                for (e = 0; e < t.length; e++) (o = $(t[e])), o.find("a.item-ss") != undefined && o.find("a.item-ss").hasClass("active") == !1 && o.find("a.item-ss").addClass("active").html("<i></i> ÄĂ£ thĂªm so sĂ¡nh");
            s = $(".box02 *[data-id=" + f + "]").first();
            s != undefined && s.length > 0 && t.hasClass("active") == !1 && s.addClass("active").html("<i class='icondetail-sosanh'></i> ÄĂ£ thĂªm so sĂ¡nh");
        }
}
function randomBannerTop() {
    ...
    if (!isRandomBannerTop) {
        ...
        ((e = document.querySelector(".media-slider .item")), (h = document.querySelector(".media-slider .item a").getAttribute("href")), o == h && (e.remove(), r.appendChild(e)));
...
function closenotify() {
    ...
    $.ajax({ url: urlRoot + "/Common/AddCookiesCovid", type: "POST", cache: !1, beforeSend: function () {}, success: function () {}, error: function () {} });
}
...
function changePoupDistrictV2(n, t, i) {
    ...
    $.ajax({
        ...
        success: function (n) {
            n != "" && ($(i).addClass("active"), $("#lst-dis").addClass("hide").hide(), $("#lst-ward").html(n).removeClass("hide").show(), $("#hdLocationDisId").val(t), callTitleLocation());
            $("#dldingtext").hide();
        },
        error: function () {
            $("#dldingtext").hide();
...
function callTitleLocation() {
    ...
    var n = "",
        t = "",
        i = "";
    $("#lst-dis li a").length > 0 && $("#lst-dis").is(":visible") && ((t = "Quáº­n, huyá»‡n táº¡i "), (n = $("#lst-prov li a.active").text().trimStart().trimEnd()));
    $("#lst-ward li a").length > 0 && $("#lst-ward").is(":visible") && ((i = "PhÆ°á»ng xĂ£ táº¡i "), (t = $("#lst-dis li a.active").text().trimStart().trimEnd() + ", "), (n = $("#lst-prov li a.active").text().trimStart().trimEnd()));
...
function backLocation(n = false) {
    ...
    $("#lst-dis").hasClass("hide") && n == !1 ? $("#lst-dis").removeClass("hide").show() : ($("#lst-dis").addClass("hide").hide(), $("#lst-prov").removeClass("hide").show(), resetPopupLocation());
    checkingBackIcon();
    $("#lst-dis").is(":visible") && n == !1 && callTitleLocation();
}
function checkingBackIcon() {
    !$("#lst-prov").hasClass("hide") || $("#lst-prov").is(":visible") ? $("a.back-ic").hide() : $("a.back-ic").show();
}
function getLocationCustomer() {
    ...
    try {
        ...
        s = window.location.hostname.indexOf("newstaging") > -1 || window.location.hostname.indexOf("localhost") > -1;
        ...
        ((n = JSON.parse(c)),
            ...
            (e = n != null && n != undefined ? n.DistrictType + " " + n.DistrictName : ""),
            (r = n != null && n != undefined ? n.WardId : 0),
            (o = n != null && n != undefined ? n.WardType + " " + n.WardName : ""),
            (u = n != null && n != undefined && n.CustomerSex >= 0 ? n.CustomerSex : -1));
    } catch (c) {
        t = 0;
        i = 0;
        r = 0;
    ...
    return { provinceID: t > 0 ? t : 0, provinceName: f, districtID: i > 0 ? i : 0, districtName: e, wardID: r > 0 ? r : 0, wardName: o, Sex: u >= 0 ? u : -1 };
}
function clearPopupLocation(n = false) {
    if (($("#hdLocationDisId").val(0), $("#hdLocationWardId").val(0), n && $("#hdLocationProvinceId").val() !== getLocationCustomer().provinceID.toString())) {
        locationConfirm();
        return;
    }
    backLocation(n);
...
function gotoSuggestLocation(n) {
    ...
    u > 0 && i > 0
        ? ($("#hdLocationProvinceId").val(t), $("#hdLocationDisId").val(i), $("#hdLocationWardId").val(u), locationConfirm())
        : i > 0 && t > 0
            ? changePoupProvinceV2(t, $("#lst-prov ul").find("a[data-value=" + t + "]"), i)
            : t > 0 && (backLocation(!0), changePoupProvinceV2(t, $("#lst-prov ul").find("a[data-value=" + t + "]")));
...
function resetPopupLocation() {
    ...
    getLocationCustomer().wardID > 0
        ? ($(".top-location .default-title").addClass("hide").hide(), $(".top-location .full-location").removeClass("hide").show())
        : ($(".top-location .default-title").removeClass("hide").show(), $(".top-location .full-location").addClass("hide").hide());
}
function callFirstLoadPopup() {
    getLocationCustomer().wardID > 0
        ? ($("p.default-title").addClass("hide").hide(),
            $("p.full-location").removeClass("hide").show(),
        (fullAddress == "" || fullAddress == undefined) && (fullAddress = $("#lst-prov li a.active").length > 0 ? $("#lst-prov li a.active").text() : "Há»“ ChĂ­ Minh"),
            $(".fulladdress-v2").html(fullAddress))
        : ($("p.default-title").removeClass("hide").show(), $("p.full-location").addClass("hide").hide());
}
...
function CheckBoxBHX() {
    $("#form-zone-bhx .productbox-bhxapi-item").length >= 5 && $("#form-zone-bhx").removeClass("hide");
}
...
function AddColorBox(n, t, i) {
    if (typeof i == "object") i.status == -1 && alert(i.error);
        ...
        $(n).length == 0
            ...
            : ($(n).replaceWith(i), $.colorbox.resize({ width: $(n).width() + "px" }), $(t).remove());
    }
}
...
function GetLivestreamHeader() {
    $.ajax({
        ...
        success: function (n) {
            n !== undefined && n !== null && n.code == 200 && $(".header-top-bar").html(n.data);
        },
    });
}
    ...
    if (
        (n.preventDefault(),
            ...
            $(".header__search .dropdownsearch").length > 0
                ? ((r = $(".header__search .dropdownsearch a").data("id")), r == 1 && (t = t.toString().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|\(|\)|{|}|\[|\]|\\|\|/gi, "")))
                : (t = t.toString().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|_|-|\(|\)|{|}|\[|\]|\\|\|/gi, "")),
...
function goToSearchPage(n, t) {
    var i,
        e = n.toString().replace(/:|;|!|@@|#|\$|%|\^|&|\*|'|"|>|<|,|\?|`|~|\+|=|_|-|\(|\)|{|}|\[|\]|\\|\|/gi, ""),
        f = e.trim(),
        r = encodeURIComponent(f).replace(/\./g, "+").replace(/%20/gi, "+").replace(/ /g, "+"),
        u;
    t !== undefined && t > 0 && (r = r + "&cate=" + t);
    $(".header__search .dropdownsearch").length > 0
        ? ((u = $(".header__search .dropdownsearch a").data("id")), u == 1 ? (i = "/game-app/tim-kiem?key=" + r) : u == 2 ? (i = "/tim-kiem?key=" + r) : u == 3 && (i = "/tin-tuc/tim-kiem?key=" + r))
        : isUsedProduct
...
"undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
    (function (n) {
        ...
        n.migrateWarnings && t.console.log("JQMIGRATE: Migrate plugin loaded multiple times"),
            t.console.log("JQMIGRATE: Migrate is installed" + (n.migrateMute ? "" : " with logging active") + ", version " + n.migrateVersion));
        e = {};
        ...
        (r(
            ...
            r(n, "isArray", Array.isArray, "jQuery.isArray is deprecated; use Array.isArray"));
        u("3.3.0") &&
        (r(
            n,
            "isNumeric",
            ...
            n.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (n, t) {
        ...
        ((b = n.ajax),
            ...
            (n.ajax = function () {
                ...
                return (
                    n.promise && (r(n, "success", n.done, "jQXHR.success is deprecated and removed"), r(n, "error", n.fail, "jQXHR.error is deprecated and removed"), r(n, "complete", n.always, "jQXHR.complete is deprecated and removed")), n
                );
            }),
        u("4.0.0") ||
        ...
        n.fn.css = function (t, r) {
            ...
            return t && "object" == typeof t && !Array.isArray(t)
                ? (n.each(t, function (t, i) {
                    ...
                    this)
                : ("number" == typeof r && ((f = l(t)), (u = f), (pt.test(u) && wt.test(u[0].toUpperCase() + u.slice(1))) || n.cssNumber[f] || i('Number-typed values are deprecated for jQuery.fn.css( "' + t + '", value )')),
        ...
        n.data = function (t, r, u) {
            ...
            return r && "string" == typeof r && r !== l(r) && (o = n.hasData(t) && f.call(this, t)) && r in o
                ? (i("jQuery.data() always sets/gets camelCased names: " + r), 2 < arguments.length && (o[r] = u), o[r])
        ...
        return (
            (n.event.props = []),
                (n.event.fixHooks = {}),
                h(n.event.props, "concat", n.event.props.concat, "jQuery.event.props.concat() is deprecated and removed"),
...
AutoComplete = (function () {
    function n(t, i) {
        if ((t === void 0 && (t = {}), i === void 0 && (i = "[data-autocomplete]"), Array.isArray(i)))
        ...
        } else n.prototype.create(n.merge(n.defaults, t, { DOMResults: document.createElement("div") }), i);
    }
    return (
        (n.prototype.create = function (t, i) {
            ...
            (n.prototype.event = function (t, i) {
                ...
                for (f in t.KeyboardMappings)
                    (u = n.merge({ Operator: ConditionOperator.AND }, t.KeyboardMappings[f])),
                        (r = ConditionOperator.AND == u.Operator),
                        u.Conditions.forEach(function (t) {
                            ((r === !0 && u.Operator == ConditionOperator.AND) || (r === !1 && ConditionOperator.OR)) &&
                            ((t = n.merge({ Not: !1 }, t)),
                                t.hasOwnProperty("Is") ? (r = t.Is == i.keyCode ? !t.Not : t.Not) : t.hasOwnProperty("From") && t.hasOwnProperty("To") && (r = i.keyCode >= t.From && i.keyCode <= t.To ? !t.Not : t.Not));
                        }),
            ...
            (n.merge = function () {
                for (var i = {}, t, n = 0; n < arguments.length; n++) for (t in arguments[n]) i[t] = arguments[n][t];
                return i;
            }),
            (n.defaults = {
                Delay: 150,
                    ...
                    AlphaNum: {
                        ...
                        Callback: function () {
                            var t = this.Input.getAttribute("data-autocomplete-old-value"),
                                i = this._Pre();
                            i !== "" &&
                            ((t && i == t) || this.DOMResults.setAttribute("class", "autocomplete open"),
                                n.prototype.ajax(
                                    this,
                                    function () {
                ...
                _Render: function (n) {
                    ...
                    if (typeof n == "string") {
                        n.length > 0
                            ...
                            u !== "" && ((t.innerHTML = u), t.setAttribute("class", "locked"), r.appendChild(t), this.DOMResults.hasChildNodes() && this.DOMResults.removeChild(this.DOMResults.childNodes[0]), this.DOMResults.appendChild(r)));
                        return;
                    }
                ...
                _Post: function (n) {
                    ...
                    try {
                        ...
                        if (Array.isArray(t)) for (r = 0; r < Object.keys(t).length; r++) i[i.length] = { Value: t[r], Label: t[r] };
...
(function (n, t, i) {
    ...
    function kt(t, i) {
        ...
        this.value = function (t) {
            var r;
            return (
                this.cache[t] === undefined && ((r = n(this.el).attr("data-cbox-" + t)), r !== undefined ? (this.cache[t] = r) : i[t] !== undefined ? (this.cache[t] = i[t]) : ni[t] !== undefined && (this.cache[t] = ni[t])), this.cache[t]
            );
        };
        this.get = function (t) {
            var i = this.value(t);
        ...
        if (!lt) {
            if (((e = n(i).data(y)), (r = new kt(i, e)), gi(r.get("rel")), !it)) {
                ...
                var c = a(r.get("initialWidth"), "x"),
                    ...
                    rt = r.get("maxHeight");
                if (
                    ((r.w = Math.max((g !== !1 ? Math.min(c, a(g, "x")) : c) - tt - k, 0)),
                        (r.h = Math.max((rt !== !1 ? Math.min(v, a(rt, "y")) : v) - nt - b, 0)),
            ...
            d.css({ opacity: f === f ? f : "", cursor: r.get("overlayClose") ? "pointer" : "", visibility: "visible" }).show();
    ...
    function ki() {
        ...
        ((li = !1),
            (g = n(i)),
            (u = o(h)
                .attr({ id: y, class: n.support.opacity === !1 ? e + "IE" : "", role: "dialog", tabindex: "-1" })
                .hide()),
            (d = o(h, "Overlay").hide()),
            ...
            rt
                .append(
                    o(h).append(o(h, "TopLeft"), (ri = o(h, "TopCenter")), o(h, "TopRight")),
                    o(h, !1, "clear:left").append((ui = o(h, "MiddleLeft")), p, (fi = o(h, "MiddleRight"))),
                    o(h, !1, "clear:left").append(o(h, "BottomLeft"), (ei = o(h, "BottomCenter")), o(h, "BottomRight"))
                )
                .find("div div")
                .css({ float: "left" }),
            (ot = o(h, !1, "position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;")),
                ...
                if (
                    ((li = !0),
                        ...
                        n(t).bind("keydown." + e, function (n) {
                            var t = n.keyCode;
                            it && r.get("escKey") && t === 27 && (n.preventDefault(), s.close());
    ...
    function ir() {
        ...
        if (
            ((ct = !0),
                ...
                ut(vt),
                r.get("onLoad"),
                (r.h = r.get("height") ? a(r.get("height"), "y") - nt - b : r.get("innerHeight") && a(r.get("innerHeight"), "y")),
                (r.w = r.get("width") ? a(r.get("width"), "x") - tt - k : r.get("innerWidth") && a(r.get("innerWidth"), "x")),
                (r.mw = r.w),
                (r.mh = r.h),
            r.get("maxWidth") && ((r.mw = a(r.get("maxWidth"), "x") - tt - k), (r.mw = r.w && r.w < r.mw ? r.w : r.mw)),
            r.get("maxHeight") && ((r.mh = a(r.get("maxHeight"), "y") - nt - b), (r.mh = r.h && r.h < r.mh ? r.h : r.mh)),
                (t = r.get("href")),
            ...
            n(f)
                ...
                .one("load", function () {
                    ...
                    setTimeout(function () {
                        ...
                        r.mw && f.width > r.mw && ((t = (f.width - r.mw) / f.width), y()),
                        r.mh && f.height > r.mh && ((t = (f.height - r.mh) / f.height), y()));
            ...
            ot.load(t, r.get("data"), function (t, i) {
                d === ci && u(i === "error" ? o(h, "Error").html(r.get("xhrError")) : n(this).contents());
            });
    }
    var ni = {
            html: !1,
        ...
        nr = (function () {
            ...
            function o() {
                (r.get("loop") || c[v + 1]) && (t(), (l = setTimeout(s.next, r.get("slideshowSpeed"))));
            }
            function a() {
    ...
    n[y] ||
    (n(ki),
        (s = n.fn[y] = n[y] = function (t, i) {
            var u,
                r = this;
            return ((t = t || {}), n.isFunction(r) && ((r = n("<a/>")), (t.open = !0)), !r[0])
                ? r
                : (ki(),
                tr() &&
                (i && (t.onComplete = i),
        ...
        (s.position = function (t, i) {
            ...
            l = g.scrollTop();
            v = g.scrollLeft();
            r.get("fixed") ? ((o.top -= l), (o.left -= v), u.css({ position: "fixed" })) : ((h = l), (c = v), u.css({ position: "absolute" }));
        ...
        (s.resize = function (n) {
            ...
            n.innerHeight || n.height || ((t = l.scrollTop()), l.css({ height: "auto" }), (r.h = l.height())),
                l.css({ height: r.h }),
            t && l.scrollTop(t),
                            ...
                            ((o = function () {
                                ...
                                f > 1
                                    ...
                                    si
                                        ...
                                        .show(),
                                        st[r.get("loop") || v < f - 1 ? "show" : "hide"]().html(r.get("next")),
                                        ht[r.get("loop") || v ? "show" : "hide"]().html(r.get("previous")),
                                        nr(),
                                    r.get("preloading") &&
...
var urlRoot = window.location.origin,
    ...
    isLoadData = !1,
    fullAddress = "",
    isRunLive = urlRoot.indexOf("www.thegioididong.com") > -1 || urlRoot.indexOf("www.dienmayxanh.com") > -1,
    isStaging = urlRoot.indexOf("staging.thegioididong.com") > -1 || urlRoot.indexOf("staging.dienmayxanh.com") > -1 || urlRoot.indexOf("newstaging.thegioididong.com") > -1 || urlRoot.indexOf("newstaging.dienmayxanh.com") > -1,
    isBeta = urlRoot.indexOf("beta.thegioididong.com") > -1 || urlRoot.indexOf("beta.dienmayxanh.com") > -1 || urlRoot.indexOf("newsbeta.thegioididong.com") > -1 || urlRoot.indexOf("newsbeta.dienmayxanh.com") > -1,
...
$(document).ready(function () {
    ...
    if (
        ...
        ($(".header__search .dropdownsearch").length > 0 || $(".focused").length > 0) && ((isHasSub = !0), (subID = $("header.header").data("sub"))),
        ...
        $("#skw").click(function () {
            ...
            $(".suggest_search li").length > 0
                ...
                : $(this).val() != ""
                    ...
                    : isSearchHis && !isUsedProduct && ($("#search-result").html(""), ViewSearchKeywordHistory());
        }),
            GetDataInfor(),
            GetQuanatyCart(),
        $(".dmca-badge").length > 0 && ((i = $(".dmca-badge").attr("href") + "&refurl=" + location.href), $(".dmca-badge").attr("href", i)),
...
$(window).scroll(function () {
    !laodBHX && $(".zone-bhx").length > 0 && ((laodBHX = !0), (typeof callfromsub == "undefined" || callfromsub == !1) && GetProductBHX());
    !loadBHX && $("#showPromoteBHX").length > 0 && ((loadBHX = !0), (typeof callfromsub == "undefined" || callfromsub == !1) && ShowProductBHX());
});
...
pdbxbhxapi = {
    ...
    validEmail: function () {
        ...
        return t
            ? ($(".voucherproduct-bhx input[name=email]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").addClass("hidden"), !0)
            : ($(".voucherproduct-bhx .voucher-error").text("Email khĂ´ng Ä‘Ăºng Ä‘á»‹nh dáº¡ng"), $(".voucherproduct-bhx .voucher-error").removeClass("hidden"), $(".voucherproduct-bhx input[name=email]").addClass("input-warning"), !1);
    },
    validPhone: function () {
        var n = $(".voucherproduct-bhx input[name=phone]").val(),
            t = pdbxbhxapi.checkPhone(n);
        return t
            ? ($(".voucherproduct-bhx input[name=phone]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").addClass("hidden"), !0)
            : ($(".voucherproduct-bhx .voucher-error span").text("Sá»‘ Ä‘iá»‡n thoáº¡i khĂ´ng Ä‘Ăºng Ä‘á»‹nh dáº¡ng"),
    ...
    sendCoupon: function () {
        ...
        if (!pdbxbhxapi.loading) {
            var n = { email: $(".voucherproduct-bhx input[name=email]").val(), phone: $(".voucherproduct-bhx input[name=phone]").val() };
            $.ajax({
                ...
                success: function (t) {
                    if (((pdbxbhxapi.loading = !1), t.result)) {
                        ...
                        i += '<div class="s-img"><img width="44" height="44" src="https://cdn.tgdd.vn/bachhoaxanh/www/Content/images/dmxtgdd/dmxtgdd-check.png"></div>';
                        ...
                        $(".voucherproduct-bhx .voucher-error").text(t.message),
                            $(".voucherproduct-bhx .voucher-error").removeClass("hidden"),
                        isMobile && ($(".productbox-bhxapi div._voucher").addClass("hide-voucher-note"), $(".voucherproduct-bhx .voucher-note").hide());
                },
                error: function () {
    ...
    checkValid: function (n) {
        ...
        if (n == "email" || n == undefined) {
            if (i == "")
                return (
                    $(".voucherproduct-bhx .voucher-error").text("Email khĂ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng"),
                        $(".voucherproduct-bhx .voucher-error").removeClass("hidden"),
                        $(".voucherproduct-bhx input[name=email]").addClass("input-warning"),
                        $(".voucherproduct-bhx button").attr("disabled", "disabled"),
                        !1
                );
            if (((t = pdbxbhxapi.validEmail()), !t)) return $(".voucherproduct-bhx button").attr("disabled", "disabled"), !1;
        }
        if (n == "phone" || n == undefined) {
            if (r == "")
                return (
                    $(".voucherproduct-bhx .voucher-error").text("Sá»‘ Ä‘iá»‡n thoáº¡i khĂ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng"),
                        $(".voucherproduct-bhx .voucher-error").removeClass("hidden"),
                        $(".voucherproduct-bhx input[name=phone]").addClass("input-warning"),
                        $(".voucherproduct-bhx button").attr("disabled", "disabled"),
                        !1
                );
            if (((t = pdbxbhxapi.validPhone()), !t)) return $(".voucherproduct-bhx button").attr("disabled", "disabled"), !1;
        }
        return n == "email" && r != "" && ((t = pdbxbhxapi.validPhone()), !t)
            ...
            : n == "phone" && i != "" && ((t = pdbxbhxapi.validEmail()), !t)
                ? ($(".voucherproduct-bhx button").attr("disabled", "disabled"), !1)
                : r != "" && i != ""
                    ? ($(".voucherproduct-bhx .voucher-error").addClass("hidden"), $(".voucherproduct-bhx input").removeClass("input-warning"), $(".voucherproduct-bhx button").removeAttr("disabled"), !0)
                    : void 0;
    },
    ...
    checkActiveSubmit: function () {
        ...
        ($(".voucherproduct-bhx button").removeAttr("disabled"), $(".voucherproduct-bhx .voucher-error").addClass("hidden"), $(".voucherproduct-bhx input").removeClass("input-warning"));
        pdbxbhxapi.checkPhone(n) &&
        ($(".voucherproduct-bhx input[name=phone]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").text().indexOf("Sá»‘ Ä‘iá»‡n thoáº¡i") != -1 && $(".voucherproduct-bhx .voucher-error").addClass("hidden"));
        pdbxbhxapi.checkEmail(t) &&
        ($(".voucherproduct-bhx input[name=email]").removeClass("input-warning"), $(".voucherproduct-bhx .voucher-error").text().indexOf("Email") != -1 && $(".voucherproduct-bhx .voucher-error").addClass("hidden"));
    },
...
$(document).ready(function () {
    ...
    setTimeout(function () {
        ...
        ((hrefnewdv = location.href),
            ...
            (hrefnewdv = location.pathname.includes("?") ? urlRoot + n + "&sclient=mobile" + location.hash : urlRoot + n + "?sclient=mobile" + location.hash),
            $(".linkversion").attr("href", hrefnewdv));
    }, 600);
    $(".main-menu li").length > 0 &&
    $(".main-menu li").each(function () {
        if (location.pathname.split("/")[1] == $(this).find("a").attr("href").replace("/", "")) return $(this).addClass("active"), !1;
    });
    $(".header__listtop .divitem").length > 0 &&
    $(".header__listtop .divitem").each(function () {
        if (location.pathname.includes($(this).find("a").attr("href"))) return $(this).addClass("active"), !1;
    });
});
$(document).ready(function () {
    ...
    $(".header__main .main-menu li").each(function (n, t) {
        n > parseInt($(".header__main .main-menu li").length / 2) && $(t).addClass("show-left");
    });
});
1;
